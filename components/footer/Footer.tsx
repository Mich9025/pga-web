...
export const Footer = async () => {
  ...
  const socials = [
    {
      name: "Facebook",
      href: "https://www.facebook.com/PGAConstructoress/",
      icon: (props: any) => (
    ...
    {
      name: "Instagram",
      href: "https://www.instagram.com/pgaconstructores/",
      icon: (props: any) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
      ...
      <Section className="">
        <Container className="!pt-0 !pb-6">
          <div className="flex">
            ...
            <div className="flex justify-center gap-x-6 md:order-2 ml-auto pt-2">
              {socials.map((item) => (
                <a
                  key={item.name}
                  href={item.href}
